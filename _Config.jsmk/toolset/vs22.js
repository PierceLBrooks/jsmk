...
const vcVers = "14.39.33519"; // "14.40.33807"; // "14.38.33130"; // "14.37.32822"; // "14.36.32532"; // "14.35.32215";
...
function getConfig(arch)
{
    ...
    {
        sdkVers = sdkVersions[i];
        if(jsmk.path.exists(`${sdkRoot}/10/bin/${sdkVers}`)) // == "existsSync"
            break;
    }
    if(sdkVers != sdkVersions[0])
        jsmk.DEBUG("WARNING vs22 using older sdkVers " + sdkVers);
    let c = {
